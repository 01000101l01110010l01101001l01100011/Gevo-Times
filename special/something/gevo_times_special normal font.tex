...
% \titleformat{\section}{\fontfamily{phv}\fontseries{bx}\fontshape{n}\selectfont\Large}{\thesection}{1em}{}
...
\begin{center}
 ...
 \begin{tikzpicture}[remember picture,overlay]
    \node [yshift=99mm] (logo) at (current page.center)
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.69\textwidth]{ny}
\end{figure}
